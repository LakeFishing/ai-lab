...
model01 = load_model('project2/t2h5/CNN01.h5')
model02 = load_model('project2/t2h5/CNN02.h5')
model03 = load_model('project2/t2h5/CNN03.h5')
model04 = load_model('project2/t2h5/CNN04.h5')
model05 = load_model('project2/t2h5/CNN05.h5')
model06 = load_model('project2/t2h5/CNN06.h5')
model07 = load_model('project2/t2h5/CNN07.h5')
model08 = load_model('project2/t2h5/CNN08.h5')
model09 = load_model('project2/t2h5/CNN09.h5')
model10 = load_model('project2/t2h5/CNN10.h5')
model11 = load_model('project2/t2h5/CNN11.h5')
model12 = load_model('project2/t2h5/CNN12.h5')
...
def predict_q():
    ...
    li = []
    for i in range(1, ws.max_row + 1):  # 問句如果有多段要改這裡
        li.clear()
        wb = openpyxl.load_workbook(fn)
        ws = wb['Sheet3']
        rowA = ws[i]
        ...
        for j in range(len(excel_save)):
            ws.cell(row= 2 * i, column=j + 1, value=excel_save[j])
        wb.save('proj2.xlsx')

    print('done predict_q.py')
